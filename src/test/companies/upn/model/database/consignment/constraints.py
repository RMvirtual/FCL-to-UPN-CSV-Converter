import unittest
from src.main.companies.upn.model.database.consignment.network.constraints \
...
class TestNetworkConsignmentConstraints(unittest.TestCase):
    ...
    def test_should_get_type_constraint(self) -> None:
        self.assertEqual("int", self._constraints.depot_no.type_constraint)

    def test_should_get_value_constraints(self) -> None:
        self.assertListEqual(
            ["P", "S", "I", "R"],
            self._constraints.main_service.value_constraints
        )
