import unittest
from src.main.companies.bridges.graylaw_upn.adaptors\
    .network_pallet import NetworkPalletAdaptor

from src.test.companies.bridges.graylaw_upn.adaptors.network_pallet import \
    setup
