import unittest
from src.main.third_party_bridges.graylaw_upn.adaptors.network_consignment \
    import NetworkConsignmentAdaptor

from src.test.third_party_bridges.graylaw_upn.adaptors.network_consignment\
    .setup import graylaw_setup, upn_setup
