...
from src.main.time.dates.model.formats.string.recognition \
    import FormatRecognition
...
class TestDateFormatRecognition(unittest.TestCase):
    ...
    def test_should_recognise_numeric_only_format(self):
        ...
        self._predicate_against_values(FormatRecognition.is_numeric)
    ...
    def test_should_recognise_alphabetic_format(self):
        ...
        self._predicate_against_values(FormatRecognition.is_alphanumeric)
    ...
    def test_should_recognise_separated_formats(self):
        ...
        self._predicate_against_values(FormatRecognition.has_separators)
    ...
    def test_should_recognise_whitespace_formats(self):
        ...
        self._predicate_against_values(FormatRecognition.has_whitespace)
    ...
    def _predicate_valid_values_are_true(self, predicate_callback) -> None:
        for date in self._valid_dates:
            self.assertTrue(
                predicate_callback(FormatRecognition(date)), msg=date)
