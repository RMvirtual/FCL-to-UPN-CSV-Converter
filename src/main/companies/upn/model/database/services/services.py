from src.main.companies.upn.model.database.consignment.network.keys \
...
from src.main.companies.upn.model.implementation.service.specific \
    import UPNService
from src.main.companies.upn.model.interface.services.container \
